...
SPPNet에서는 다양한 크기의 input을 받을 수 있기떄문에, 네트워크의 견고함(robustness)을 다지기위해 학습시에 다양한 크기의 input을 사용할 수 있다.
...
1. R-CNN처럼 Selective Search로 약 2000개의 region propsals를 만들어 사용한다.
...
Microsoft는 ILSVRC에서 PReLUNet and ResNet와 같은 여러개의 state-of-the-art 모델을 제출했다. 다음에는 해당 모델에 대해 알아보자.
